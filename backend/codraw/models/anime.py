...
class Genre(models.Model):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = 'Жанры'
...
class Rating(models.Model):
    ...
    value = models.FloatField(validators=[MinValueValidator(0), MaxValueValidator(5)], verbose_name='Оценка')

    class Meta:
        constraints = [UniqueConstraint(fields=['owner', 'anime'], name='unique_anime_user')]
        verbose_name = verbose_name_plural = 'Рейтинг'
